 ...
 * in the same class group and one swallows the other.
 */
export const twMergeConfig = {
  extend: {
    ...
    classGroups: {
      // Duration has no theme key in tailwind-merge -- it only accepts
      // numbers. Without this, `duration-fast` would not know it overrides
      // `duration-slow`.
