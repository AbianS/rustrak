...
#[openapi(
    ...
    paths(
        ...
        crate::routes::monitors::list_monitors,
        crate::routes::monitors::get_monitor,
        crate::routes::monitors::create_monitor,
        crate::routes::monitors::update_monitor,
        crate::routes::monitors::delete_monitor,
        crate::routes::monitors::trigger_check,
    ),
    components(schemas(
        ...
        crate::models::monitor::CreateMonitor,
        crate::models::monitor::UpdateMonitor,
