...
import { COMMANDS, type CommandItem } from '@/shared/config/commands';
...
export default function CommandBarDialog({
  ...
  // Results shrink as the query narrows, so keep the highlight inside the list.
  const active =
            ...
            results.map((command, index) => (
              ...
              >
                <span className="flex items-center gap-1.5">
                  {command.platform === undefined && command.icon ? (
