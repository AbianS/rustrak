...
> **Production deployment?** If your DSN shows `0.0.0.0` instead of your domain, set `PUBLIC_URL=https://api.yourcompany.com` in your server environment. See [Environment Variables](/configuration/environment#public_url).
